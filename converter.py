...
print(Fore.BLUE +' --------------  NUMBER TO EMAIL TOOL------------------ ')
print("Unique script to convert phone number email carrier gateway into email format")
print('')

print(Fore.GREEN + 'Select services')
print(Fore.LIGHTMAGENTA_EX + '(1) verizon (2) AT&T wireless (3)AT&T mobility (4)Boost mobile (5)Cricket (6)Metro PCS (7)Sprint[pcs] ')
print(Fore.LIGHTMAGENTA_EX +'(8)Sprint[Nextel] (9)Straight talk (10)Tmobile (11)U.S cellular (12)Virgin Mobile')
print("")
input_value=input(Fore.RED + "Enter option  ")
